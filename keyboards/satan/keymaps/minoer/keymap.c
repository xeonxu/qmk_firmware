...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |Tab/Ten| Q| W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|Bksp |
   * |-----------------------------------------------------------|
   * |LCtl   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;| '|Ret/RCtl|
   * |-----------------------------------------------------------|
   * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift| fn |
   * |-----------------------------------------------------------|
   * |Caps|Alt |fn  |      Space/Mouse      |Gui |Alt |MEH |HYPR |
   * `-----------------------------------------------------------'
   */
[SAFE] = KEYMAP_HHKB(
   ...
   * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift| fn |
   * |-----------------------------------------------------------|
   * |HYPR|Alt |fn  |      Space/Mouse      |Gui |Alt |MEH |HYPR |
   * `-----------------------------------------------------------'
   */
[BASE] = KEYMAP_HHKB(
  F(0),    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV, \
   ...
   * |-----------------------------------------------------------|
   * |Caps |   |   |   |   |   |   |   |Psc|Slk|Pau| Up|   | Del |
   * |-----------------------------------------------------------|
   * |Caps |VOLD|VOLU|MUTE|  |  | * | / |Hom|Pgu|Lft|Rgt|Ret/RCtl|
   * |-----------------------------------------------------------|
   * |        |   |   |   |   |   |   | + | - |End|Dwn|  Up |Lay |
   * |-----------------------------------------------------------|
   * |    |    |    |                       |    |Left|Down|Rght |
...
[LAYER_SET] = KEYMAP_HHKB(
   ...
   * |-----------------------------------------------------------|
   * |Tabs |   |   |   |   |   |   |Bt1|MSU|Bt2|Bt3|Bt4|Bt5|     |
   * |-----------------------------------------------------------|
   * |Caps |   |   |   |   |   |   |MSL|MSD|MSR|   |   | Ret/RCtl|
   * |-----------------------------------------------------------|
   * |LSft    |   |   |   |   |   |   |   |   |   |   | WHU |    |
   * |-----------------------------------------------------------|
   * |    |    |    |                       |    | WHL| WHD|WHR  |
