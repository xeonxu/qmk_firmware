...
[LAYER_SET] = KEYMAP_HHKB(
  ...
  KC_CAPS,XXXXXXX,  KC_ACL0,KC_ACL1,KC_ACL2, XXXXXXX, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, _______, XXXXXXX,  MT(MOD_RCTL,KC_ENT), \
 ...
 /* Layer 6: Tenkey layer
   ...
   */
  [TENKEY] = KEYMAP_HHKB(
   KC_ESC, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PSLS,KC_PAST,KC_PMNS, XXXXXXX, XXXXXXX,  XXXXXXX, \
   _______,XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_KP_7, KC_KP_8, KC_KP_9, KC_PPLS, KC_PPLS, KC_BSPC, \
   _______,XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_KP_4, KC_KP_5, KC_KP_6, KC_PENT, KC_PENT, \
   _______,XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_KP_1, KC_KP_2, KC_KP_3, _______, _______, \
